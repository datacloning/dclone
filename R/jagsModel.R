...
#' 
#' \code{jagsModel} is used to create an object representing a Bayesian
#' graphical model, specified with a BUGS-language description of the prior
#' distribution, and a set of data. This function uses
#' \code{\link[rjags]{jags.model}} but keeps track of data cloning information
#' supplied via the \code{data} argument. The model argument can also accept
#' functions or 'custommodel' objects.
#' 
#' 
...
#' or a function. If omitted, initial values will be generated automatically.
#' It is an error to supply an initial value for an observed node.
#' @param n.chains the number of chains for the model
...
#' environment, see \code{\link[rjags]{jags.model}} for details.
#' 
